...
class UserRegistrarModel {
  ...
  factory UserRegistrarModel.fromMap(Map<String, dynamic> map) {
  ...
  factory UserRegistrarModel.fromDocument(DocumentSnapshot documentSnapshot) {
