...
class SurveyCashierOfficeController extends GetxController {
  ...
  String currentState() =>
      'SurveyCashierOfficeController(Status: ${_status.value}, Question1: ${question1.value}, Question2: ${question2.value}, Question3: ${question3.value}, Question4: ${question4.value}, Optional: ${optional.value} )';
  ...
  Future<void> submitData() async {
    ...
    if (question1.value == SurveyEnum.unknown ||
      ...
      await SurveyRepository.createSurveyCashierOffice(userData);
