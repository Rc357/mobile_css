...
class SurveyRegistrarOfficeView
    extends GetView<SurveyRegistrarOfficeController> {
  const SurveyRegistrarOfficeView({super.key});
                          ...
                          child: Column(
                            children: [
                              Column(
                                ...
                                children: [
                                  Obx(
                                    () => controller.registrarQuestions.isEmpty
                                        ? const Center(
                                            child: Padding(
                                        ...
                                        : ListView.separated(
                                            ...
                                            itemCount: controller
                                                .registrarQuestions.length,
                                            itemBuilder: (context, index) {
                                              final question = controller
                                                  .registrarQuestions[index];
                                              return Column(
                                                crossAxisAlignment:
