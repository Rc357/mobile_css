...
class SurveySecurityOfficeView extends GetView<SurveySecurityOfficeController> {
  const SurveySecurityOfficeView({super.key});
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Obx(
                                    () => controller
                                            .securityOfficeQuestions.isEmpty
                                        ? const Center(
                                            child: Padding(
